...
/*
result== [
  'constructor',      'cGetName',
  'constructor',      'pGetName',
  Symbol(pAge),       'constructor',
  'gGetName',         Symbol(gAge),
...
function logAllProperties1(instance) {
    if (instance == null) return;
    let proto = instance.__proto__;
    while (proto) {
        result1.push(...Reflect.ownKeys(proto));
        proto = proto.__proto__;
    }
}

logAllProperties1(person);
